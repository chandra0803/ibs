...
public class AmadeusMediatorUtil {

	private static final Log LOGGER = LogFactory.getLog(AmadeusMediatorUtil.class);
	...
	public static String getSoapPassword(String password, String createdDate, String nonce) {
		...
		try {
			...
			LOGGER.error("Exception in dcsgetSoapPassword :: ", e);
		}
		LOGGER.info("dcspasswordDigest: " + passwordDigest);
	...
	public static String getSoapNonce() {
		...
		try {
			...
			LOGGER.error("Exception in dcsgetSoapNonce: ", e);
		}
		return nonce;
	}
