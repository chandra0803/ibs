 ...
 *       &lt;sequence>
 *         &lt;element name="passengerReference" type="{http://xml.amadeus.com/APALRR_17_1_1A}ReferencingDetailsType_285598C" maxOccurs="99"/>
...
public class ReferenceInformationType {
    ...
    protected List<ReferencingDetailsType285598C> passengerReference;
     ...
     * {@link ReferencingDetailsType285598C }
     * 
     * 
     */
    public List<ReferencingDetailsType285598C> getPassengerReference() {
        if (passengerReference == null) {
            passengerReference = new ArrayList<ReferencingDetailsType285598C>();
        }
